...
BANNED_WORDS = ['porn', 'violence', 'hate speech',
                'sex', 'fight', 'war', 'music']

# Alternative safe search terms
SAFE_SEARCH_TERMS = ['science', 'animal education',
                     'kids art', 'english', 'maths']
...
def search():
    ...
    if request.method == 'POST':
        ...
        for word in BANNED_WORDS:
            filtered_query = re.sub(rf'\b{word}\b', '',
                                    filtered_query, flags=re.IGNORECASE)
